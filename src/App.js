        ...
        <div className="flex h-screen">
          <div className="w-full lg:w-3/12 m-auto">
            <div className="space-y-3 w-full">
              <h1 className="font-bold text-xl text-center text-white ">TodoList</h1>
              <div className="flex">
                <div className="w-full">
                  <form action="" className="text-black space-y-3" onSubmit={submitHandler}>
                    ...
                    <div className="text-center text-white bg-blue-500 px-4 py-2 rounded hover:bg-blue-700 hover:cursor-pointer">
